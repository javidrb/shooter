class Boss extends Opponent {
    constructor(game) {
        const height = OPPONENT_HEIGHT * game.width / 100 * 3;
        const width = OPPONENT_WIDTH * game.width / 100* 3;
        const x = getRandomNumber(game.width - width / 2);
        const y = 0;

        super(game, width, height, x, y);

        this.myImage = "assets/burns-excellent.gif";
        this.myImageDead = "assets/burns-excellent.gif";
